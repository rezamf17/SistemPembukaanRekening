...
<head>
    ...
    <title>@yield('title') | BPRS Al-Masoem</title>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div style="width: 70%;">
                    ...
                    <img src="{{asset('style/img/LogoAlMasoemIB-removebg.png')}}" class="img-fluid" alt="Responsive image">
                </div>
                <div class="sidebar-brand-text mx-3">BPRS Al-Masoem</div>
            </a>
...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Copyright &copy; BPRS AL-MASOEM 2021</span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
...
<script>
    $('.delete-nasabah').click(function (){
        ...
        .then((willDelete) => {
          if (willDelete) {
            window.location = "/nasabahHapus/"+nasabahId+""
            swal("Data berhasil dihapus!", {
              icon: "success",
          });
        } else {
