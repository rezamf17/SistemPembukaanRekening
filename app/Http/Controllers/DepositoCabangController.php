...
class DepositoCabangController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('admin.Data Nasabah.EditDepositoCabang', compact('deposito'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('depositoCabang/'.Auth::user()->id_cabang)->with('success', 'Data Berhasil Diedit!');
    }
