...
class DataNasabahController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('super-admin.Data Nasabah.DataNasabah', compact('formulir'));
    }
    ...
    public function show($id)
    {
        ...
        return view('super-admin.Data Nasabah.LihatNasabah', compact('formulir'));
    }
    ...
    {
        $formulir = Formulir::where('id', $id)->first();
        return view('super-admin.Data Nasabah.EditNasabah', compact('formulir'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('nasabah')->with('success', 'Data Berhasil Diedit!');
    }
